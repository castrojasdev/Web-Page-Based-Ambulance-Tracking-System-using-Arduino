...
function Company({navigation}) {
    return (
        ...
        <TouchableOpacity style={styles.touchbutton1} onPress={()=> navigation.navigate('student')}>
        <View style={styles.button} >
            <MaterialCommunityIcons  name='home-outline' size={30} color={"white"}/>
        </View>
        </TouchableOpacity>
           
        <TouchableOpacity style={styles.touchbutton}  onPress={()=> navigation.navigate('Login')}>
        <View style={styles.button} >
        ...
        <View style={styles.button1} >
            <MaterialCommunityIcons  name='devices' size={30} color={"#686A6C"}/>
        </View>
        </TouchableOpacity> 
